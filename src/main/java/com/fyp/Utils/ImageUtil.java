...
import com.fyp.Model.BoxPosition;
...
public class ImageUtil {
     ...
     */
    public String labelImage(final byte[] image, final List<Recognition> recognitions, final String fileName, final String outputDir) {
        ...
        graphics.dispose();
        return saveImage(bufferedImage, outputDir + fileName);
    }
